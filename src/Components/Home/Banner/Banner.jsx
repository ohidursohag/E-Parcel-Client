  ...
  return (
    ...
    >
      ...
      <div className="flex-1 space-y-2 lg:space-y-5">
        <h1 className="text-3xl md:text-[35px] lg:text-[45px] xl:text-[60px] leading-none ">A Trusted Provider Of <br /> <span className="font-bold text-orange-500">Courier Services.</span></h1>
        ...
        <Link to={user?.email? `/dashboard/${role}/statistics`:'/login'} className="text-xl mx-auto md:mx-0 w-max px-5 py-3 bg-orange-500 text-white relative overflow-hidden group z-10 rounded-lg shadow-md flex items-center gap-2">
         ...
         Get Started <FaTruckArrowRight /></Link>
      </div>
