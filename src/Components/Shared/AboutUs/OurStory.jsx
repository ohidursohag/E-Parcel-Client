      ...
      <div className="flex flex-col md:flex-row items-center ">
        ...
        <div className="md:w-3/5 md:p-5 lg:p-10">
          ...
          <p className="text-justify">
            e-Parcel is Bangladesh’s most trusted on-demand last mile logistics
          ...
          <br />
          <p className="text-justify">
            We take care of order fulfillment, collection, transport, tracking
            and delivery of parcels. We are the first in Bangladesh to have
            created a unique network with home delivery and Store Pickup &
            Return services which enhances customer experience and rationalizes
            costs
          </p>
