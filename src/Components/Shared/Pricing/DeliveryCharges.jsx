...
const DeliveryCharges = () => {
  ...
  return (
    <div>
      ...
      <div className="text-lg  text-center  border-b-2 transition-colors duration-300 font-bold flex justify-center gap-x-5 xl:gap-10 ">
        <div
      ...
      <>
        {/* inside Dhaka */}
        {deliveryArea === "inside" && (
          <div className="flex flex-col md:flex-row shadow-[5px_5px_16px_0px_rgba(249,115,22,.5),-1px_-1px_16px_1px_rgba(249,115,22,.5)] rounded-lg overflow-hidden my-5 lg:my-10 2xl:w-4/5 mx-auto">
            ...
            <div className="flex-1 flex flex-col justify-center items-center gap-5 p-5 xl:gap-10">
              ...
              <p className=" font-medium">
                *15 tk Charge will be added upto 10 kg
              </p>
            </div>
          </div>
        )}
        ...
        {deliveryArea === "outside24" && (
          <div className="flex flex-col md:flex-row shadow-[5px_5px_16px_0px_rgba(249,115,22,.5),-1px_-1px_16px_1px_rgba(249,115,22,.5)] rounded-lg overflow-hidden my-5 lg:my-10 2xl:w-4/5 mx-auto">
            ...
            <div className="flex-1 flex flex-col justify-center items-center gap-5 p-5 xl:gap-10">
              ...
              <p className=" font-medium">
                *20 tk Charge will be added upto 10 kg
              </p>
            </div>
          </div>
        )}
